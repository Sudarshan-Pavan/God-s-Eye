...
void setup() 
{
  ...
  motor1.setMaxSpeed(1300.0); // Adjust this value based on Motor 1's maximum speed
  motor1.setAcceleration(15.0); // Adjust this value based on Motor 1's characteristics

  motor2.setMaxSpeed(1300.0); // Adjust this value based on Motor 2's maximum speed
  motor2.setAcceleration(1300.0); // Adjust this value based on Motor 2's characteristics
